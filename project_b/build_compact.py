...
<section id="weibo"><h2>六、微博来源与关注（官方组件）</h2>
<p class="sub">本页嵌入<b>微博官方「微博秀」组件</b>，实时展示来源账号的公开微博。本站只做汇总统计与索引，不镜像正文。</p>
<div class="weibo-widget" style="display:flex;gap:16px;flex-wrap:wrap;align-items:flex-start">
  <iframe title="王晰微博（官方组件）" loading="lazy" width="380" height="520" frameborder="0"
    src="https://widget.weibo.com/weiboshow/index.php?uid=1292815744&width=380&height=520&fansRow=2&ptype=1&speed=0&skin=1&isTitle=1&noborder=1&isWeibo=1&isFans=0&show_v=0&show_w=1"
    style="border:1px solid #eee4d8;border-radius:10px;background:#fff"></iframe>
  <div style="flex:1 1 260px;min-width:240px">
    <p><b>来源账号</b></p>
    <ul>
      <li><a href="https://weibo.com/u/1292815744" rel="nofollow">王晰本人微博</a></li>
      <li><a href="https://weibo.com/u/7215995153" rel="nofollow">王晰工作室微博</a></li>
    </ul>
    <p class="sub">若组件未能加载（网络或平台策略），可用上面链接直接访问；本站语料库中的微博条目均来自这两个账号的<b>公开内容</b>，
    仅用于个人学习研究，不二次分发、不提供原文下载。</p>
  </div>
</div>
</section>
<h2>五、免责与边界</h2>
