...
**本站原则**：不搬运原图/视频/全文，只提供**文字摘要 + 结构化信息**。公开页不写 @ID，不宣称「授权开放」或索引粉丝现场视频（版权风险）。原始链接仅存星厂 B 本地档案。
...
| 视觉记录 | `gallery.html` | 文字描述 + 品牌官方造型索引（无粉丝视频索引） |
...
| 2 | （本地档案） | 大粉解读六巡「回」主题 | 从「回」字解读六巡立意与现场气质，偏主题感受型 repo。公开站匿名，不写 @。 |
...
> **禁止**：在 city-guides / gallery / 社交墙宣称「某某授权开放现场视频索引」。  
> 即使粉丝口头授权，公开站也只收录**文字 repo 摘要**，不索引视频原链，避免版权与 @ID 风险。

如需本地备查，链接仅存 `project_b/01_原始数据/`，不上传 GitHub。
...
- [ ] `gallery.html` 仅有文字描述与合规外链（无粉丝视频授权索引）
