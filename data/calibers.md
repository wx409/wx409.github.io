...
> 生成时间：2026-09-16 14:02　｜　生成脚本：`project_b/build_calibers.py`（幂等，部署时自动重跑）
>
...
| `stage_low_reviewed` | 巡演现场低音读数·谐波列复核通过条数 | **156** | archive_stage_tour.json 中复核状态为「谐波列复核通过」的素材条数 | `data\archive_stage_tour.json` |
