...
> 生成时间：2026-09-14 17:56　｜　生成脚本：`project_b/build_calibers.py`（幂等，部署时自动重跑）
>
...
| `kb_facts` | 知识库事实条数 | **1417** | 结构化事实 | `data/kb/manifest.json` |
| `kb_entities` | 知识库实体数 | **1511** | 人/歌/专辑/演出/城市等实体 | `data/kb/manifest.json` |
| `kb_relations` | 知识库关系数 | **2074** | 实体间关系 | `data/kb/manifest.json` |
| `semantic_docs` | 语义索引文档数 | **4897** | 可语义检索的文档块 | `data/kb/semantic/manifest.json` |
...
| `index_days` | 指数数据覆盖天数 | **1287** | 站点图表所用指数长表的实际覆盖天数 | `E:\wx\wx_textmine_out\music_index_long.csv` |
